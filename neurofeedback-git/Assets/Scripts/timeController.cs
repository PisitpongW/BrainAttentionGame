...
public class timeController : MonoBehaviour {
	...
	void Update () {
        if (isContinue)
        {
            ...
            if (isTimeSet) // update time text every frame
            {
                //print("isTimeSet");
                ...
                {
                    onSetting(); // after end of playing in setted time 
                }
            }
            else
            {
